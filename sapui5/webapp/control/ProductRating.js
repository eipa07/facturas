...
sap.ui.define([
    ...
    return Control.extend("com.sapui5.control.ProductRating", {
        ...
        onInit: function () {
            ...
            }).addStyleClass("sapUiSmalMargin"));

            this.setAggregation("_button", new Button({
                text: "{i18n>productRatingButton}",
                press: this._onSubmit.bind(this)
            }).addStyleClass("sapUiTinyMarginTipeButton"));
        ...
        reset: function () {
            ...
            this.getAggregation("_button").setDesign("standard");
